...
## `contrato proximo-numero` ✅ { #contrato-proximo-numero }
...
## `contrato delete` ✅ { #contrato-delete }
...
## `contrato encerrar` ✅ { #contrato-encerrar }
