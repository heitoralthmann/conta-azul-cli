...
- Instalação simplificada para um único caminho, documentado e testado:
  `git clone` + `composer install`. Ajustes correspondentes em
  `.gitignore`, `.gitattributes` e na decisão de empacotamento registrada
  em `ESPECIFICACAO.md`.
