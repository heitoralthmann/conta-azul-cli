...
#[AsCommand(name: 'transferencia create', description: 'Cria uma transferência entre contas financeiras')]
final class CreateCommand extends Command
{
    ...
    {
        $this
            ->addOption('json', null, InputOption::VALUE_REQUIRED, 'Payload JSON da transferência')
