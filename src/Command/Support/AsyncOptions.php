...
{
  private const int DEFAULT_POLL_TIMEOUT = 60;
  ...
  public static function configure(Command $command): void {
    $command
          ->addOption(
              ...
              'Timeout de polling em segundos',
              (string) self::DEFAULT_POLL_TIMEOUT,
          )
          ->addOption(
              'no-wait',
              null,
              InputOption::VALUE_NONE,
              'Retorna imediatamente sem aguardar confirmação assíncrona',
          );
  }
