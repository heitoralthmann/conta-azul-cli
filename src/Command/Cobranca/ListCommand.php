...
namespace ContaAzulCli\Command\Cobranca;
...
#[AsCommand(name: 'cobranca list', description: 'Lista cobranças')]
final class ListCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            ...
            $this->jsonRenderer->render($this->client->listCobrancas($pagina, $tamanhoPagina));
